      ...
      <div class="col-md-6">
        <form action="/posts">
          ...
          <div class="input-group mb-3">
            ...
            <button class="btn btn-danger" type="submit" value="search">Search</button>
          </div>
        </form>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 mb-3">
            <div class="card">
              <div class="position-absolute px-3 py-2" style="background-color: rgba(69, 69, 69, 0.845); border-radius:0 0 10px 0">
